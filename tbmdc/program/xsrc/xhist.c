...
void open_xhist(void)
{
  ...
  Ek.y = (int)(-60*(sys.kin*sys.perMol)/(1000*EK_MAX))+150;
  ...
  temp.y = (int)(-60*(sys.kin*sys.e2t)/TEMP_MAX)+330;
  pres.x = (int)(300*sys.step/ctl.calc_max)+80;
  pres.y = (int)(-60*(sys.pres*sys.pp2gpa)/(10*PRES_MAX))+390;
