...
void get_control_param(void)
{
  ...
  /* check */
  sys.Ax = 1.326;     /* initial lattice constant */
  sys.Ay = 1.326;     /* initial lattice constant */
  sys.Az = 1.326;     /* initial lattice constant */
/*
  sys.Ay = 3.55984;
  sys.Az = 3.55984;
*/
  ...
  /* check */
  sys.N = 4*sys.nx*sys.ny*sys.nz;  /* total number of ions [diamond strct.] */
...
void	set_roc(void)
{
  ...
  /* 4-Carbon system: bond length at equilibrium is 1.310 [A]           */
  ...
  sys.rx[i] = 6.0+sys.Ax+sys.Ay;
  sys.ry[i] = 6.0;
  sys.rz[i] = 6.0;
  i++;

  sys.rx[i] = 6.0+sys.Ax+sys.Ax+sys.Ax;
  sys.ry[i] = 6.0;
  sys.rz[i] = 6.0;
  i++;
