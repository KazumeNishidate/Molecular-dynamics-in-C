...
void get_control_param(void)
{
  ...
  delta_time_fs = 1.0;   /* 1 [fs] = 0.001 [ps] = 1.0 X 10^(-15) [s] */
  ...
  /* check */
  sys.Ax = 1.322;   /* initial lattice constant */
  sys.Ay = 1.41;     /* initial lattice constant */
  sys.Az = 1.41;     /* initial lattice constant */

/* equliblium distance for Carbon-2 in Fermi matrix calc. */
/*  sys.Ax = 1.3282; */
  ...
  /* check */
  sys.N = 2*sys.nx*sys.ny*sys.nz;  /* total number of ions [diamond strct.] */
...
void	set_roc(void)
{
  ...
  /* 2-Carbon system: bond length at equilibrium is 1.4133 [A]          */
